...
1. [Create a fork](https://help.github.com/articles/fork-a-repo/) of the [repository](https://github.com/kianmeng/webservice-restcountries).
...
project.
    ...
    $ docker build -t webservice-countries .
    $ docker run -it -v $(pwd):/root webservice-countries bash
